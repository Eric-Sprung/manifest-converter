...
public class TemplateModelImpl extends TemplateModelBase {
  ...
  public TemplateModelImpl(TemplateModule module) {
    ...
    model = PersistenceFacade.getInstance().createModelReference("r:6357e749-ef68-478f-98ea-f1b11fc9f288(K8sManifests.templates@generator)");
  }
  public String getLongName() {
    return "K8sManifests.templates";
  }
  ...
  public TemplateDeclaration loadTemplate(TemplateDeclarationKey key) {
    ...
    if (template.equals(new SNodePointer("r:6357e749-ef68-478f-98ea-f1b11fc9f288(K8sManifests.templates@generator)", "7604103637184947011"))) {
