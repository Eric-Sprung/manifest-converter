...
<language namespace="ProductionReadyArtefact" uuid="f987a4bd-5afd-4e35-924c-05d449fe3368" languageVersion="0" moduleVersion="1">
  ...
  <accessoryModels />
  <generators>
    <generator alias="Generators" namespace="ProductionReadyArtefact.generator02" uuid="0447950e-9a53-4c07-9903-b0ea1aebd2c7" generatorOutputPath="${module}/generators/source_gen">
      <models>
        <modelRoot contentPath="${module}/generators" type="default">
          <sourceRoot location="templates" />
        </modelRoot>
      </models>
      <facets>
        <facet type="java">
          <classes generated="true" path="${module}/generators/classes_gen" />
        </facet>
      </facets>
      <external-templates />
      <languageVersions>
